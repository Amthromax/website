...
const TrustTransparencyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black">
      ...
      {/* Hero Header Section */}
      <section className="relative pt-32 pb-20 px-6 sm:px-12 md:px-16 lg:px-20 max-w-[1550px] mx-auto border-b border-white/10">
        <div className="max-w-4xl space-y-6">
          ...
          <div className="pt-4 flex flex-wrap gap-4 items-center text-xs text-gray-400 font-medium">
      ...
      {/* Trust Metrics Bar */}
      <section className="py-12 px-6 sm:px-12 md:px-16 lg:px-20 max-w-[1550px] mx-auto border-b border-white/10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="space-y-1">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Uptime SLA</p>
            <p className="text-3xl font-extrabold text-white">99.99%</p>
            <p className="text-[11px] text-gray-500">Multi-region active failover</p>
          </div>
          <div className="space-y-1">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Customer Data Opt-In</p>
          ...
          <div className="space-y-1">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Encryption Standard</p>
            <p className="text-3xl font-extrabold text-white">AES-256</p>
            <p className="text-[11px] text-gray-500">At rest & TLS 1.3 in transit</p>
          </div>
          <div className="space-y-1">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Safety Audits</p>
            <p className="text-3xl font-extrabold text-white">Quarterly</p>
      ...
      <section className="py-24 px-6 sm:px-12 md:px-16 lg:px-20 max-w-[1550px] mx-auto border-b border-white/10 space-y-16">
        ...
        >
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <h3 className="text-2xl sm:text-4xl font-serif text-white tracking-tight leading-snug">
            ...
            <div className="pt-4 grid grid-cols-2 gap-6 border-t border-white/10">
              {selectedPillar.metrics.map((m, idx) => (
                <div key={idx} className="space-y-1">
                  <span className="text-xs text-gray-400 font-medium block">{m.label}</span>
                  <span className="text-xl sm:text-2xl font-extrabold text-white">{m.value}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Right Checklist */}
          <div className="lg:col-span-6 space-y-4 border-l border-white/10 pl-6 lg:pl-10">
            ...
            <div className="space-y-4">
              {selectedPillar.details.map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 py-3 border-b border-white/5">
                  <div className="w-5 h-5 rounded-full bg-white/10 text-white flex items-center justify-center text-xs shrink-0 mt-0.5 font-bold">
                    ✓
                  </div>
      ...
      <section className="py-24 px-6 sm:px-12 md:px-16 lg:px-20 max-w-[1550px] mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link to="/privacy-center" className="group block border-t border-white/10 pt-6 pb-4 hover:border-white/30 transition-all">
            <div className="space-y-3">
              <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Compliance Report</span>
          ...
          <Link to="/security" className="group block border-t border-white/10 pt-6 pb-4 hover:border-white/30 transition-all">
            <div className="space-y-3">
              <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Architecture Whitepaper</span>
              <h3 className="text-lg font-bold text-white group-hover:text-blue-400 transition-colors">
          ...
          <Link to="/data-protection" className="group block border-t border-white/10 pt-6 pb-4 hover:border-white/30 transition-all">
            <div className="space-y-3">
              <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Legal Framework</span>
              <h3 className="text-lg font-bold text-white group-hover:text-blue-400 transition-colors">
      ...
      {/* SECTION: Security Compliance & Accreditation (Matches Screenshot) */}
      <section className="py-24 px-6 sm:px-12 md:px-16 lg:px-20 border-t border-white/10 bg-black text-white text-center">
        <div className="max-w-4xl mx-auto space-y-10 sm:space-y-12">
          ...
          <p className="text-base sm:text-lg md:text-xl text-white font-normal leading-relaxed max-w-3xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-gray-300 font-normal leading-relaxed max-w-2xl mx-auto">
            Visit{" "}
            <Link to="/security" className="text-white underline underline-offset-4 hover:text-gray-300 transition-colors font-medium">
              Amthromax trust portal
            </Link>{" "}
            to learn more about our security controls, and{" "}
            <Link to="/data-protection" className="text-white underline underline-offset-4 hover:text-gray-300 transition-colors font-medium">
