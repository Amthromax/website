...
export const ProfilePage: React.FC = () => {
  ...
  const provider = rawProvider.includes("google") || rawProvider === "email" || user.identities?.some((i: any) => i.provider === "google") || user.user_metadata?.iss?.includes("google") || !user.app_metadata?.provider
    ? "GOOGLE OAUTH"
