...
function generateSitemap() {
  ...
  const routes = [
    ...
    { loc: 'https://amthromax.com/codehoomer', changefreq: 'weekly', priority: '0.9' },
    { loc: 'https://amthromax.com/helleious', changefreq: 'weekly', priority: '0.9' },
    { loc: 'https://amthromax.com/orarqlow', changefreq: 'weekly', priority: '0.9' },
    ...
    { loc: 'https://amthromax.com/safety', changefreq: 'monthly', priority: '0.7' },
    { loc: 'https://amthromax.com/trust', changefreq: 'monthly', priority: '0.7' },
    { loc: 'https://amthromax.com/team', changefreq: 'monthly', priority: '0.7' },
    { loc: 'https://amthromax.com/charter', changefreq: 'monthly', priority: '0.7' },
